...
const data = [
    {
        ...
        text: 'Мы предоставляем быструю и надежную доставку во все регионы России, что делает покупки более доступными. При необходимости выкупим товар за вас и предоставим бесплатный склад до дня отправки, а вы сможете отслеживать свою посылку с момента заказа до получения.',
        img: '/images/aq.1.jpg'
    },
    {
        id: 2,
